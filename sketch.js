...
var PLAY = 1, END = 0, gamestates = PLAY, gameover, restart, gameoverpic, restartbutton;
...
function setup() {
  ...
  trex.addAnimation("pricked",trex_collided);
  trex.scale = 0.5;
...
function draw() {
  ...
  spawnObstacles();
    ...
    trex.changeAnimation("pricked",trex_collided);
